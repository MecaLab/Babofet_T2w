...
nnUNetv2_predict -i {input_folder} -o {output_folder} -d {dataset_id} -c 3d_fullres -tr nnUNetTrainerBiasField1000epochs -f all --save_probabilities
...
if __name__ == "__main__":
    ...
    subject_sessions = {
        "Bibi": ["ses04", "ses05", "ses06", "ses08", "ses09"],
