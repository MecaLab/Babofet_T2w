...
if __name__ == "__main__":
    ...
    volume_1 = nib.load("/scratch/lbaptiste/data/recons_folder/Fabienne/ses01/manual_brainmask/exp_param/sub-Fabienne_ses-01_haste_3DHR_manual_bm_4C_pipeline.nii.gz")
    ...
    plot_histo(volume_1_data, "Two step cycle 4")
    """plot_histo(volume_2_data, "Threshold 13")
    plot_histo(volume_3_data, "Threshold 46")"""
    plot_histo(volume_ref_data, "Default two step cycle")
    ...
    idxs = [25, 50, 75]
    for idx in idxs:
        plot_intensity_profile(volume_1_data, idx, axis=2, label=f"Two step cycle 4 ({idx})")
