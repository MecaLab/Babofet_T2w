...
if __name__ == "__main__":
    ...
    params = [None, "T-1", "T13", "T46", "MSSR1", ] # "B1", "B1_T-1", "B1_T13", "B1_T46"]
    names = ["default-param", "threshold_-1", "threshold_0.1_0.3", "threshold_0.4_0.6", "mask_ssr", ] #  "bias-field-correction", "bias-field-correction_threshold_-1", "bias-field-correction_threshold_0.1_0.3", "bias-field-correction_threshold_0.4_0.6"]
