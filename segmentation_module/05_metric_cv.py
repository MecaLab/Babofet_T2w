...
def compute_metric_models(nb_folds=5):
    ...
    for model_name, trainer_dir in MODELS.items():
        ...
        print(model_name, model_name in dice_by_class_models)
...
def plot_results(dice_by_class_models):
...
def rank_models(dice_by_class_models, models):
    ranking = []
...
if __name__ == "__main__":
    dice_by_class_models = compute_metric_models(nb_folds=5)
    plot_results(dice_by_class_models)
    rank_models(dice_by_class_models, list(MODELS.keys()))