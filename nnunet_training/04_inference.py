...
nnUNetv2_predict -i {input_folder} -o {output_folder} -d 1 -c 3d_fullres -tr nnUNetTrainer_10epochs__nnUNetPlans -f 1 
...
if __name__ == "__main__":
    input_folder = "/scratch/lbaptiste/data/nnUNet_raw/Dataset001_Babofet/"
